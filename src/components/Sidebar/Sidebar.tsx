...
const MainMenu: MenuItem[] = [
  ...
  { id: 'create-project', icon: BiMovie, text: 'Tạo theo chủ đề', link: '/create-project' },
  { id: 'form-input-channel', icon: BiMovie, text: 'Tạo dự án mới theo kênh', link: '/form-input-channel' },
  // { id: 'create-project', icon: BiMovie, text: 'Tạo theo chủ đề', link: '/create-project' },
];
    ...
    <div className="neon-box fixed left-0 top-0 w-70 h-screen bg-cyber-light z-10">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5 space-y-3">
        ...
        <button
          ...
          className="neon-button-secondary w-full flex items-center justify-center gap-2 text-sm"
        >
